...
public class ImapUTF7 extends UTF7 {
	 ...
	 * @param aliases
	 */
	public ImapUTF7(String canonicalName, String[] aliases) {
		super(canonicalName, aliases);
		// RFC 3501 5.1.3:
		// ""&" is used to shift to modified BASE64 and "-" to shift back to US-ASCII."
		BEGIN_SHIFT = '&';
		// RFC 3501 5.1.3: "All other characters (octet values 0x00-0x1f and
		// 0x7f-0xff) are represented in modified
		// BASE64, with a further modification from [UTF-7] that "," is used
		// instead of "/"."
		BASE_64[63] = ',';
		...
		// represent
		// themselves; that is, characters with octet values 0x20-0x25 and
		// 0x27-0x7e."
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		CharBuffer result =
			imapUTF7.decode(ByteBuffer.wrap(test.getBytes("US-ASCII")));
