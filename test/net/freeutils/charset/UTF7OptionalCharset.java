 ...
 * UTF-7 charset. The O-Set characters are encoded directly (this is optional
 * according to the RFC). The encoding and decoding are based on RFC 2152
...
public class UTF7OptionalCharset extends UTF7Charset {
	...
	/**
	 * Constructs an instance of the UTF7OptionalCharset. O-set characters are
	 * directly encoded.
	 */
